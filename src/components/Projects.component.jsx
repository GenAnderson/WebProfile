        ...
        <Card>
          ...
          <Card.Body>
            ...
            <Card.Text>
              ...
              comprehensive data on these creatures. This project marks one of
              my initial endeavors at Career Foundry, showcasing my early foray
        ...
        <Card>
          ...
          <Card.Body>
            ...
            <Card.Text>
              ...
              complemented by a back-end repository also accessible on my
              website.
            </Card.Text>
            <Stack direction="horizontal" gap={2}>
              <Badge pill bg="primary">
        ...
        <Card>
          ...
          <Card.Body>
            ...
            <Card.Text>
              ...
              through the Google Calendar API. It offers users the flexibility
              to tailor their event exploration by applying filters based on
              city preferences or desired event quantity.
            </Card.Text>
            <Stack direction="horizontal" gap={2}>
              <Badge pill bg="primary">
                JS
      ...
      >
        <Card>
          ...
          <Card.Body>
            ...
            <Card.Text>
              The development of this iteration of MyFlix used Angular. Similar
              to its React counterpart, this rendition seamlessly integrates
              with my backend movie API. Crafting this version served as an
              invaluable opportunity to delve deeper into Angular and provided a
              hands-on learning experience while honing skills.
            </Card.Text>
            <Stack direction="horizontal" gap={2}>
              <Badge pill bg="primary">
                Typescript
